...
/// Token de pontuação ou espaço (não clicável e NUNCA esmaecido como palavra conhecida).
class PunctuationSpan extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // A pontuação mantém sempre a cor nítida (100% visível), sem nunca
    // assumir opacidade reduzida de palavra conhecida.
    final Color textColor;
    if (isActiveLine) {
      textColor = const Color(0xFF141F17);
    } else {
